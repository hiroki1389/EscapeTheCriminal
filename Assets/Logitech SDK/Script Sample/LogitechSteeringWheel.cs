...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    public int Handlaxisrec;
    public int Accelerator;
    public int Deceleration;

    private GameObject car_root;
    ...
    */
    ...
    void Update()
    {
        car_root = GameObject.Find("Car_root");
        rigidbody = car_root.GetComponent<Rigidbody>();
        ...
        if (LogitechGSDK.LogiUpdate() && LogitechGSDK.LogiIsConnected(0))
        {
            ...
            Handlaxisrec = rec.lX;
            Accelerator =  rec.lY;
            Deceleration =  rec.lRz;
            
            actualState += "speed :" + velocity + "\n";
